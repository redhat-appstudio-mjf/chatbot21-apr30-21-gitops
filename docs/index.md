...
# Application
An application built from https://github.com/redhat-appstudio-mjf/chatbot21-apr30-21 will be stored in [quay.io/maysunfaisal/chatbot21-apr30-21](https://quay.io/maysunfaisal/chatbot21-apr30-21) and deployed through GitOps. This application is accessible on port **8501**.